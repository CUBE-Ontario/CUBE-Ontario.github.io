...
make_bio_bootstrap4 <- function(name, photo, bio){
  ...
  html_str <- glue(
    '<div class="card mb-3" style="min-height: 8rem; padding: 1rem 1rem 1rem 1rem">
...
<!-- ## We're hiring _ section-->
<div class='card bg-light mb-3' style="height:100%; width: 100%">
<!-- header -->
<div class='card-header'>
  <h5 style="margin: 5px; padding: 0px">We're hiring!</h5>
</div>
<!-- body -->
<div class='card-body'>
  We're looking for a junior technician to help us detect SARS-CoV-2 from environmental samples.
  <hr>
  <a class="btn btn-primary" href="job_posting.html" role="button">More details</a>
</div>
</div>
</div>
...
<!-- # df with one row per card -->
<!-- df <- tribble( -->
<!--   ~link, ~title, ~img_path, ~img_alt, ~body, -->
<!--   "https://www.loc.gov/item/webcast-9908/", "U.S. Library of Congress COVID19 Webinar Lecture", "pics/loc_thumb2.jpg", "Library of Congress lecture", '<h5 style="color: #2c3e50">Presented by Rees Kassen and Caroline Nott</h5><br><i class="fas fa-play"></i>&nbsp;&nbsp; <em>Skip to 44:10</em>', -->
<!--   "https://theconversation.com/swabbing-floors-to-detect-covid-19-could-be-a-useful-indicator-of-the-diseases-spread-175832","Swabbing floors to detect COVID-19 could be a useful indicator of the disease’s spread", "pics/convo_card_preview.jpeg", "'Wet floor' signs lying on a tile floor", '<h5 style="color: #2c3e50">Aaron Hinz and Rees Kassen </h5><br><p> in <em>the Conversation</em><p>' -->
<!-- ) -->

<!-- # # -->
<!-- # my_card <- function(link, title, img_path, img_alt, body) { -->
<!-- #   div( -->
<!-- #     a(href = link, -->
<!-- #       div( -->
<!-- #         class = "card border-info mb-3",# .bg-light -->
<!-- #         img(class="card-img-top", src=img_path, alt=img_alt, ), -->
<!-- #         div( -->
...
<!-- #  -->
<!-- # df |>  -->
<!-- #   dplyr::mutate(card = purrr::pmap( -->
<!-- #     .l = list(link, title, img_path, img_alt, body), -->
<!-- #     .f = function(link, title, img_path, img_alt, body){ -->
<!-- #       my_card(link, title, img_path, img_alt, body) -->
<!-- #     })) |>  -->
<!-- #   pull(card) |>  -->
<!-- #   div(class='') -->
