...
meta() |> 
  ...
  meta_general(
    ...
    description = "Website for the CUBE: Covid-19 in the Urban Built Environment study. We are investigating the utility of environmental sampling as a means for monitoring Covid-19 in congregate settings.",
    robots = 'index',
    subject = "Covid-19 SARS-CoV-2 environmental microbiology epidemiology",
    rating = "General"
  ) |>
  meta_social(
    title = "CUBE: Covid-19 in the Urban Built Environment",
    ...
    og_author = c("Evgueni Doukhanine", "Michael Fralick", "Aaron Hinz", "Benazir Hodzic-Santor", "Rees Kassen", "Derek MacFadden", "Jason Moggridge", "Caroline Nott", "Ashley Raudanskis", "Nisha Thampi", "Tamara Van Bakel", "Alex Wong", "Veronica Zanichelli"),
...
<p>Our research team is currently monitoring `r n_site` facilities in Toronto and Ottawa, including `r n_ltc` long-term care homes, `r n_dc` daycares, and `r n_uni`. 
</p>
...
zmlvl <- 6
ontario_map <-
  leaflet::leaflet(width = '80%', height = 300, padding = '5px') |>
  setView(lng = -77, lat = 44.4, zoom = zmlvl)  |>
  addProviderTiles(
  ...
  addAwesomeMarkers(
    ...
    label = ~type,
    popup = ~type,
    clusterOptions = markerClusterOptions(freezeAtZoom = zmlvl+1)
  )
ontario_map
...
<div class='row' style= "top: 0px; margin: 5px 0; p">
  <p>
  <img class='profilepic' src="pics/Evgueni.jpg" alt="Evgueni Doukhanine"> 
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img class='profilepic' src="pics/Bena_alt.jpg" alt="Benazir Hodzic-Santor"> 
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img class='profilepic' src="pics/Laura_alt.jpg" alt="Dr. Laura Hug"> 
    <h4>Dr. Laura Hug </h4>
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Rees.jpg" alt="Dr. Rees Kassen" class='profilepic'> 
...
<div class='row' style= "top: 0px; margin: 5px 0;">
  <p>
  <img src="pics/AMcGeer.jpg" alt="Dr. Allison McGeer profile image" class='profilepic'> 
    <h4>Dr. Allison McGeer</h4>
...
<div class='row' style= "top: 0px; margin: 5px 0;">
  <p>
  <img src="pics/Jason.jpeg" alt="Jason Moggridge" class='profilepic'> 
...
<div class='row' style= "top: 0px; margin: 5px 0;">
  <p>
  <img src="pics/Caroline.jpg" alt="Dr. Caroline Nott" class='profilepic'> 
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Ashley_alt.jpg" alt="Ashley Raudanskis" class='profilepic'>
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/nisha.jpg" alt="Dr. Nisha Thampi" class='profilepic'>
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Tam_alt.jpg" alt="Tamara Van Bakel" class='profilepic'>
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Alex.jpg" alt="Alex Wong" class='profilepic'>
    <h4>Dr. Alex Wong</h4>
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Veronica.jpg" alt="Veronica Zanichelli" class='profilepic'> 
...
<!-- // any text here would work unless you want to point to a particular id in the html -->
[Back to top](#) 
