...
author: "The CUBE team are: Evgueni Doukhanine, Michael Fralick, Aaron Hinz, Benazir Hodzic-Santor, Rees Kassen, Derek MacFadden, Jason Moggridge, Caroline Nott, Ashley Raudanskis, Nisha Thampi, Tamara Van Bakel, Alex Wong, and Veronica Zanichelli<br><br>"
output: 
  html_document:
    toc: true
    toc_float:
...
<!-- *--infographic here--* -->
<img class='info' src="figures/CUBE_info4.png" 
...
```{r, message=F, warning=FALSE, echo=F, fig.height=3, fig.width=3}
library(leaflet)
library(tidyverse)
