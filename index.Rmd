...
<p>Our research team is currently monitoring `r n_site` facilities in Toronto, Ottawa, and Sault Ste. Marie, including `r n_ltc` long-term care homes, `r n_dc` daycares, and `r n_uni`. 
</p>
...
<div class='row' style= "top: 0px; margin: 5px 0; p">
  <p>
  <img class='profilepic' src="pics/Lucas.jpg" alt="Lucas Castellani"> 
    <h4>Dr. Lucas Castellani</h4>
