...
meta() |> 
  ...
  meta_general(
    ...
    description = "CUBE: Covid-19 in the Urban Built Environment: Developing environmental sampling as a method for monitoring SARS-CoV-2 in congregate settings.",
    robots = 'index',
