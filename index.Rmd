...
We swab floors to pick up any Covid-19 RNA (the genetic material of the virus) that we can then detect using the RT-qPCR method. The aim of our study is to develop this technique as a means to monitor the presence of Covid-19 in congregate settings (eg. schools, daycares, long-term care homes, workplaces, *etc.*).  
...
We will try report our results to each facility on a monthly basis.

<br>

<h4 style="color:DodgerBlue";> Do we need to clean our floors more often? </h4>

No, time and resources would be better spent on improving ventilation and/or air filtration.

<br>

<h4 style="color:DodgerBlue";> Can you get COVID-19 from the floor?  </h4>
...
<h4 style="color:DodgerBlue";> Have you found any COVID-19 in our building? </h4>

<br>

<h4 style="color:DodgerBlue";> How long is the study running?  </h4>

This will depend on funding and has not yet been determined.
...
<!-- We are working with public health authorities in Toronto, Ottawa, and Algoma .... -->
<!-- Our study is funded by ... -->

<br>

<!-- <h4 style="color:DodgerBlue";> Can our study tell if virus found on floors is viable or not?</h4> -->
...
<!-- The detection of Covid-19 in floor samples is correlated with the presence of infected persons in the facility. -->
...
<!-- Dr. Caroline Nott is an Infectious Diseases Physician and Director of the Antimicrobial Stewardship Program at The Ottawa Hospital (TOH). She has supported TOH Infection Prevention and Control and Occupational Health Departments as a COVID-19 Pandemic Support Lead since April 2020.  -->
...
<div class='row' style= "top: 0px; margin: 5px 0; ">
  <p>
    <img src="pics/Alex4.jpg" alt="Alex Wong"
    class='profilepic'>
    <h4>Dr. Alex Wong</h4>
